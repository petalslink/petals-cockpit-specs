...
le deuxième niveau du change tree level, va faire disparaître les services au niveau 0 et laisser place à la liste des endpoints. A la sélection de celui-ci, l'encadré détail laissera apparaître dans l'encadré related element, l'interface et le service lui étant lié. Dans l'encadré détail endpoint, apparaîtra le bus, conteneur et composant lui étant associé.
